...
typedef struct generalPaths {
    ...
    char* people_file;             //Arquivo .pm (sem diretorio)
    ...
    char* path_people_file;        //Path ate o .pm inicial
...
void showPaths(path paths) {
    ...
    if (aux->path_people_file) {
        puts("Path arquivo pessoas : ");
        puts(aux->path_people_file);
        puts("====================");
    }
